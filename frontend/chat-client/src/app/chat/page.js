                                ...
                                <div class="flex-1 overflow-auto" style={{backgroundColor:"#DAD3CC"}}>
                                    <div class="py-2 px-3">
                                        ...
                                        <div class="flex justify-center mb-2">
                                            <div class="rounded py-2 px-4" style={{backgroundColor:"#DDECF2"}}>
                                        ...
                                        <div class="flex justify-center mb-4">
                                            <div class="rounded py-2 px-4" style={{backgroundColor:"#FCF4CB"}}>
                                                <p class="text-xs">
                                        ...
                                        <div class="flex justify-end mb-2">
                                            <div class="rounded py-2 px-3" style={{backgroundColor:"#E2F7CB"}}>
                                                <p class="text-sm mt-1">
                                                    Hi guys.
                                                </p>
                                                <p class="text-right text-xs text-grey-dark mt-1">
